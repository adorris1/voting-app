	...
	_createClass(NavbarActions, [{
		...
		value: function getCharacterCount() {
			...
			$.ajax({
				...
				_this2.actoins.getCharacterCountFail(err);
			});
		}
	}]);
...
var _navbar_store = require('../stores/navbar_store');

var _navbar_store2 = _interopRequireDefault(_navbar_store);

var _navbar_actions = require('../actions/navbar_actions');

var _navbar_actions2 = _interopRequireDefault(_navbar_actions);
...
var Navbar = (function (_React$Component) {
	...
	function Navbar(props) {
		...
		_this.state = _navbar_store2.default;
	...
	_createClass(Navbar, [{
		...
		value: function componentDidMount() {
			_navbar_store2.default.listen(this.onChange);
			_navbar_actions2.default.getCharacterCount();

			var socket = io.connect();

			socket.on('onlineUsers', function (data) {
				_navbar_actions2.default.updateOnlineUsers(data);
			});

			$(document).ajaxStart(function () {
				_navbar_actions2.default.updateAjaxAnimation('fadeIn');
			});

			$(document).ajaxComplete(function () {
				_navbar_actions2.default.updateAjaxAnimation('fadeOut');
			}, 750);
		}
	}, {
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			_navbar_store2.default.unlisten(this.onChange);
		}
	}, {
		key: 'onChange',
		...
		value: function handleSubmit(event) {
			...
			if (searchQuery) {
				_navbar_actions2.default.findCharacter({
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: this.state.totalCharacters + ' characters', value: this.state.searchQuery, onChange: _navbar_actions2.default.updateSearchQuery }),
							_react2.default.createElement(
								'span',
...
},{"../actions/navbar_actions":2,"../stores/navbar_store":11,"react":"react","react-router":"react-router"}],5:[function(require,module,exports){
'use strict';
...
},{"./Navbar":4,"./footer":6,"react":"react"}],6:[function(require,module,exports){
'use strict';
...
var _footer_store = require('../stores/footer_store');

var _footer_store2 = _interopRequireDefault(_footer_store);

var _footer_actions = require('../actions/footer_actions');

var _footer_actions2 = _interopRequireDefault(_footer_actions);
...
var Footer = (function (_React$Component) {
	...
	function Footer(props) {
		...
		_this.state = _footer_store2.default.getState();
		_this.onChange = _this.onChange.bind(_this);
		return _this;
	}
	...
	_createClass(Footer, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			_footer_store2.default.listen(this.onChange);
			_footer_actions2.default.getTopCharacters();
		}
	}, {
		key: 'componentWillUnmount',
		value: function componentWillUnmount() {
			_footer_store2.default.unlisten(this.onChange);
		}
	}, {
		key: 'onChange',
		value: function onChange(state) {
...
},{"../actions/footer_actions":1,"../stores/footer_store":10,"react":"react","react-router":"react-router"}],7:[function(require,module,exports){
"use strict";
...
},{"./components/app":5,"./components/home":7,"react":"react","react-router":"react-router"}],10:[function(require,module,exports){
'use strict';
...
var FooterStore = (function () {
	function FooterStore() {
		...
		this.bindActions(_footer_actions2.default);
		this.characters = [];
	}
...
},{"../actions/footer_actions":1,"../alt":3}],11:[function(require,module,exports){
'use strict';
...
var NavbarStore = (function () {
	function NavbarStore() {
		...
		this.bindActions(_navbar_actions2.default);
...
},{"../actions/navbar_actions":2,"../alt":3}],12:[function(require,module,exports){
